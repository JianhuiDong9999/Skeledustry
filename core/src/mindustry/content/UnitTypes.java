    ...
    public static void load(){
        ...
        mace = new UnitType("mace"){{
            ...
            weapons.add(new Weapon("flamethrower"){{
                ...
                recoil = 1f;
                ejectEffect = Fx.none;
                bullet = new BulletType(4.2f, 18.5f){{
                    ammoMultiplier = 3f;
                    hitSize = 7f;
                    lifetime = 13f;
                    pierce = true;
        ...
        fortress = new UnitType("fortress"){{
            ...
            weapons.add(new Weapon("artillery"){{
                ...
                bullet = new ArtilleryBulletType(2f, 10, "shell"){{
        ...
        scepter = new UnitType("scepter"){{
            ...
            BulletType smallBullet = new BasicBulletType(3f, 5){{
                width = 7f;
                height = 9f;
                lifetime = 50f;
            }};
        ...
        reign = new UnitType("reign"){{
            ...
            new Weapon("reign-weapon"){{
                ...
                bullet = new BasicBulletType(13f, 40){{
                    pierce = true;
                    pierceCap = 10;
                    width = 14f;
                    height = 33f;
        ...
        arkyid = new UnitType("arkyid"){{
            ...
            new Weapon("large-purple-mount"){{
                ...
                bullet = new ArtilleryBulletType(2f, 6){{
        ...
        toxopid = new UnitType("toxopid"){{
            ...
            weapons.add(new Weapon("toxopid-cannon"){{
                ...
                bullet = new ArtilleryBulletType(3f, 25){{
                    hitEffect = Fx.sapExplosion;
                    knockback = 0.8f;
                    lifetime = 80f;
                    width = height = 25f;
                    ...
                    fragBullet = new ArtilleryBulletType(2.3f, 15){{
                        hitEffect = Fx.sapExplosion;
                        knockback = 0.8f;
                        lifetime = 90f;
                        width = height = 20f;
        ...
        antumbra = new UnitType("antumbra"){{
            ...
            BulletType missiles = new MissileBulletType(2.7f, 9){{
                width = 8f;
                height = 8f;
                shrinkY = 0f;
                drag = -0.01f;
        ...
        eclipse = new UnitType("eclipse"){{
            ...
            BulletType fragBullet = new FlakBulletType(4f, 8){{
                shootEffect = Fx.shootBig;
                ammoMultiplier = 4f;
                splashDamage = 32.5f;
                splashDamageRadius = 25f;
        ...
        poly = new UnitType("poly"){{
            ...
            weapons.add(new Weapon("poly-weapon"){{
                ...
                bullet = new MissileBulletType(4f, 6){{
                    homingPower = 0.08f;
                    weaveMag = 4;
                    weaveScale = 4;
                    lifetime = 50f;
        ...
        mega = new UnitType("mega"){{
            ...
            new Weapon("heal-weapon-mount"){{
                ...
                y = -6f;
                rotate = true;
                bullet = new LaserBoltBulletType(5.2f, 5){{
                    lifetime = 35f;
                    healPercent = 5.5f;
                    collidesTeam = true;
                    backColor = Pal.heal;
            ...
            new Weapon("heal-weapon-mount"){{
                ...
                y = 5f;
                rotate = true;
                bullet = new LaserBoltBulletType(5.2f, 4){{
                    lifetime = 35f;
                    healPercent = 3f;
                    collidesTeam = true;
                    backColor = Pal.heal;
        ...
        risso = new UnitType("risso"){{
            ...
            weapons.add(new Weapon("missiles-mount"){{
                ...
                ejectEffect = Fx.casing1;
                shootSound = Sounds.missile;
                bullet = new MissileBulletType(2.7f, 6, "missile"){{
                    keepVelocity = true;
                    width = 8f;
                    height = 8f;
                    shrinkY = 0f;
        ...
        minke = new UnitType("minke"){{
            ...
            weapons.add(new Weapon("mount-weapon"){{
                ...
                ejectEffect = Fx.casing1;
                shootSound = Sounds.shoot;
                bullet = new FlakBulletType(4.2f, 2){{
                    lifetime = 60f;
                    ammoMultiplier = 4f;
                    shootEffect = Fx.shootSmall;
                    width = 6f;
            ...
            weapons.add(new Weapon("artillery-mount"){{
                ...
                ejectEffect = Fx.casing2;
                shootSound = Sounds.bang;
                bullet = new ArtilleryBulletType(3f, 10, "shell"){{
                    hitEffect = Fx.flakExplosion;
                    knockback = 0.8f;
                    lifetime = 80f;
                    width = height = 11f;
        ...
        bryde = new UnitType("bryde"){{
            ...
            weapons.add(new Weapon("large-artillery"){{
                ...
                bullet = new ArtilleryBulletType(3.2f, 8){{
                    trailMult = 0.8f;
                    hitEffect = Fx.massiveExplosion;
                    knockback = 1.5f;
                    lifetime = 84f;
            ...
            weapons.add(new Weapon("missiles-mount"){{
                ...
                ejectEffect = Fx.none;
                bullet = new MissileBulletType(2.7f, 6){{
                    width = 8f;
                    height = 8f;
                    shrinkY = 0f;
                    drag = -0.003f;
        ...
        sei = new UnitType("sei"){{
            ...
            weapons.add(new Weapon("sei-launcher"){{
                ...
                bullet = new MissileBulletType(4.2f, 21){{
                    homingPower = 0.12f;
                    width = 8f;
                    height = 8f;
                    shrinkX = shrinkY = 0f;
            ...
            weapons.add(new Weapon("large-bullet-mount"){{
                ...
                inaccuracy = 1f;
                bullet = new BasicBulletType(7f, 29){{
                    width = 13f;
                    height = 19f;
                    shootEffect = Fx.shootBig;
                    lifetime = 35f;
        ...
        retusa = new UnitType("retusa"){{
            ...
            weapons.add(new Weapon("retusa-weapon"){{
                ...
                mirror = true;
                rotate = true;
                bullet = new LaserBoltBulletType(5.2f, 6){{
                    lifetime = 30f;
                    healPercent = 5.5f;
                    collidesTeam = true;
                    backColor = Pal.heal;
        ...
        oxynoe = new UnitType("oxynoe"){{
            ...
            weapons.add(new Weapon("plasma-mount-weapon"){{
                ...
                bullet = new BulletType(3.4f, 11.5f){{
                    healPercent = 1.5f;
                    collidesTeam = true;
                    ammoMultiplier = 3f;
                    hitSize = 7f;
        ...
        cyerce = new UnitType("cyerce"){{
            ...
            weapons.add(new Weapon("plasma-missile-mount"){{
                ...
                ejectEffect = Fx.none;
                bullet = new FlakBulletType(2.5f, 13){{
        ...
        aegires = new UnitType("aegires"){{
            ...
            abilities.add(new EnergyFieldAbility(20f, 65f, 180f){{
        ...
        gamma = new UnitType("gamma"){{
            ...
            weapons.add(new Weapon("small-mount-weapon"){{
                ...
                bullet = new BasicBulletType(3.5f, 6){{
                    width = 6.5f;
                    height = 11f;
                    lifetime = 70f;
                    shootEffect = Fx.shootSmall;
